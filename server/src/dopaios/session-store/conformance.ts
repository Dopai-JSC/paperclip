// COPIED VERBATIM (except this header) from
// anthropics/claude-agent-sdk-typescript @ v0.3.220
// (commit 71c804dc8f4a61c1dca6fe10d4b95a6b65d1396b), path: examples/session-stores/shared/conformance.ts
// License: MIT (example code, not published to npm). Provenance: PROVENANCE.md
// muc "Agent SDK session-store example copy (KC-02)". Own changes live in
// DopaiosSessionStore.ts — do not edit this file.
/**
 ...
 *   })
 */
// DEVIATION (Dopai): bun:test -> vitest, one line only.
